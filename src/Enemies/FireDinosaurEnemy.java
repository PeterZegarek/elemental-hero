...
public class FireDinosaurEnemy extends Enemy {
    ...
    public FireDinosaurEnemy(Point startLocation, Point endLocation, Direction facingDirection) {
        super(startLocation.x, startLocation.y, new SpriteSheet(ImageLoader.load("FireDinosaurEnemy.png"), 14, 17), "WALK_RIGHT");
