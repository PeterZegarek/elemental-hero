...
public class Fireboss extends Enemy {
       ...
       public void update(Player player) {
               ...
               if (bossState == BossState.SHOOT_WAIT) {
                       ...
                       } else if (shootTimer == 0 && (currentAnimationName != "HURT_LEFT" || currentAnimationName != "HURT_LEFT")) {
               ...
               // this is for actually having the WaterWizard shoot the fireball
                       ...
                       PlayerFireball fireball = new PlayerFireball(fireballX - 100, fireballY, movementSpeed, 150);
